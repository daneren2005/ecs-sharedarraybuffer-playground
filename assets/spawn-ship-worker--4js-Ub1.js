...
* @license      {@link https://opensource.org/licenses/MIT|MIT License}
*/
var n=y(),r=f(),i={Angle:Ti(),Distance:ji(),Easing:Mi(),Fuzzy:Li(),Interpolation:Zi(),Pow2:ta(),Snap:aa(),RandomDataGenerator:oa(),Average:sa(),Bernstein:zi(),Between:Mr(),CatmullRom:Vi(),CeilTo:ca(),Clamp:_(),DegToRad:Ar(),Difference:la(),Euler:da(),Factorial:Ri(),FloatBetween:vi(),FloorTo:fa(),FromPercent:v(),GetSpeed:pa(),IsEven:ma(),IsEvenStrict:ha(),Linear:Wi(),LinearXY:ga(),MaxAdd:_a(),Median:va(),MinSub:ya(),Percent:ba(),RadToDeg:xa(),RandomXY:Sa(),RandomXYZ:Ca(),RandomXYZW:wa(),Rotate:Ta(),RotateAround:Ea(),RotateAroundDistance:Da(),RotateTo:Oa(),RoundAwayFromZero:ka(),RoundTo:Aa(),SinCosTableGenerator:ja(),SmootherStep:Yi(),SmoothStep:qi(),ToXY:Ma(),TransformXY:Na(),Within:Pa(),Wrap:$t(),Vector2:B(),Vector3:Q(),Vector4:Se(),Matrix3:Fa(),Matrix4:gn(),Quaternion:Ia(),RotateVec3:La()};i=r(!1,i,n),t.exports=i})),za=c(si(),1),Ba=c(Ra(),1);function Va(e,t){let n=new za.default.Point(0,0),r=Ba.default.Angle.BetweenPoints(n,new Ba.default.Vector2(e,t));return Ba.default.RadToDeg(r)}function Ha(e){switch(e){case`entity`:return 1;case`position`:return 2**1;case`velocity`:return 2**2;case`health`:return 2**3;case`controller`:return 2**4;case`controlled`:return 2**5;case`attack`:return 2**6;default:return 0}}function Ua(e){let t=0;return e.forEach(e=>{t|=Ha(e)}),t}function Wa(e,t,n){Atomics.or(e.entity.components,t,Ua(n))}function Ga(e){let t=Ka(e);for(;t===!1;)t=Ka(e);return t}function Ka(e){let t=Atomics.load(e.recycledIndexes,0);if(t>0){let n=Atomics.load(e.recycledIds,t);return n===0||Atomics.compareExchange(e.recycledIndexes,0,t,t-1)!==t?!1:(Atomics.compareExchange(e.recycledIds,t,n,0),Atomics.store(e.components.entity.init,n,0),Atomics.store(e.components.entity.components,n,0),Atomics.store(e.components.entity.dead,n,0),n)}else return Atomics.add(e.idCounter,0,1)+1}function qa(e,t){let n=Ua(t),r=[],i=Atomics.load(e.idCounter,0);for(let t=0;t<=i;t++)(Atomics.load(e.components.entity.components,t)&n)===n&&Atomics.load(e.components.entity.dead,t)===0&&r.push(t);return r}function Ja(e){let t=e.components.controller,n=e.components.controlled,r=e.components.position,i=e.components.velocity,a=e.components.health;return()=>{qa(e,[`controller`]).forEach(o=>{if(t.money[o]>0){let s=Ga(e);Wa(e.components,s,[`entity`,`position`,`health`,`velocity`,`controlled`,`attack`]),Atomics.store(r.width,s,10*1e3),Atomics.store(r.height,s,5*1e3),Atomics.store(a.shields,s,1),Atomics.store(a.maxShields,s,1),Atomics.store(a.timeToRegenerateShields,s,1e3*1e3),Atomics.store(i.speed,s,100),Atomics.store(n.owner,s,o),Atomics.store(r.x,s,Atomics.load(r.x,o)),Atomics.store(r.y,s,Atomics.load(r.y,o));let c=(Math.random()>.5?-1:1)*Math.random()*100,l=(Math.random()>.5?-1:1)*Math.random()*100;Atomics.store(i.x,s,c),Atomics.store(i.y,s,l),Atomics.store(r.angle,s,Va(c,l)),Atomics.sub(t.money,o,1),Atomics.store(e.components.entity.init,s,1)}})}}l(Ja)})();